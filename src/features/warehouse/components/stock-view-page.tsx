      ...
      <div className='flex flex-1 flex-col space-y-6'>
        ...
        <div className='grid gap-4 md:grid-cols-2'>
          ...
          <Card>
            <CardHeader>
              <CardTitle className='flex items-center gap-2'>
                ...
                Chuyến nhập hàng đang vận chuyển
              </CardTitle>
              <CardDescription>
                Theo dõi các chuyến hàng đang trên đường về kho
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-4'>
                  ...
                  .map((delivery) => (
                    ...
                    >
                      ...
                      <div className='grid grid-cols-2 gap-4 text-sm'>
                        ...
                        <div className='flex items-center gap-1'>
                          <IconRoute className='h-3 w-3 text-blue-500' />
                          <span>ETA: {delivery.estimatedArrival}</span>
                        </div>
                        <div className='flex items-center gap-1'>
                          <IconTemperature className='h-3 w-3 text-orange-500' />
                          <span>{delivery.temperature}°C</span>
                        </div>
                        <div className='flex items-center gap-1'>
                          <IconDroplet className='h-3 w-3 text-blue-500' />
                          <span>{delivery.humidity}%</span>
                        </div>
                      </div>
                ...
                {activeDeliveries.filter((d) => d.type === 'import').length ===
                  0 && (
                  <div className='text-muted-foreground py-8 text-center'>
                    <IconTruck className='mx-auto mb-2 h-8 w-8 opacity-50' />
                    <p>Không có chuyến nhập hàng nào đang vận chuyển</p>
                  </div>
                )}
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className='flex items-center gap-2'>
                <IconTrendingDown className='h-5 w-5 text-blue-500' />
                Chuyến xuất hàng đang vận chuyển
              </CardTitle>
              <CardDescription>
                Theo dõi các chuyến hàng đang giao đến khách hàng
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-4'>
                  ...
                  .map((delivery) => (
                    ...
                    >
                      ...
                      <div className='grid grid-cols-2 gap-4 text-sm'>
                        ...
                        <div className='flex items-center gap-1'>
                          <IconRoute className='h-3 w-3 text-blue-500' />
                          <span>Đến: {delivery.destination}</span>
                        </div>
                        <div className='flex items-center gap-1'>
                          <IconTemperature className='h-3 w-3 text-orange-500' />
                          <span>{delivery.temperature}°C</span>
                ...
                {activeDeliveries.filter((d) => d.type === 'export').length ===
                  0 && (
                  <div className='text-muted-foreground py-8 text-center'>
                    <IconTruck className='mx-auto mb-2 h-8 w-8 opacity-50' />
                    <p>Không có chuyến xuất hàng nào đang vận chuyển</p>
                  </div>
                )}
              </div>
            </CardContent>
