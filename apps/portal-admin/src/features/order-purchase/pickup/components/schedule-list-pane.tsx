...
interface ScheduleListPaneProps {
  ...
  searchQuery: string;
  statusFilter: HarvestScheduleStatus | 'all';
  page: number;
  pageCount: number;
  limit: number;
  hasNextPage: boolean;
  ...
  onStatusFilterChange: (status: HarvestScheduleStatus | 'all') => void;
        ...
        <div className='space-y-1.5 pb-3'>
          {loading ? (
            ...
            schedules.map((schedule) => {
              ...
              const hasProducts = (schedule.harvestDetails?.length || 0) > 0;
                  ...
                  <div className='flex items-start justify-between gap-1.5'>
                    <div className='min-w-0 flex-1'>
                      ...
                      <div className='text-muted-foreground flex flex-wrap items-center gap-x-3 gap-y-0.5 text-[11px]'>
                        ...
                        {hasProducts && (
                          <span className='flex items-center gap-0.5'>
                            {schedule.harvestDetails?.length} SP
                          </span>
                        )}
                      </div>
                    </div>
