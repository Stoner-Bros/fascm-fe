...
import type { HarvestScheduleStatus } from '@/types/harvest-schedule';
import { Check, Clock, Truck, X } from 'lucide-react';
import { useTranslations } from 'next-intl';

interface HarvestStatusStepperProps {
  status: HarvestScheduleStatus | null | undefined;
  reason?: string | null;
}

export function HarvestStatusStepper({
  status,
  reason
}: HarvestStatusStepperProps) {
  const t = useTranslations('HarvestOrders.detail.statusStepper');
  const currentStatus = status as HarvestScheduleStatus;
