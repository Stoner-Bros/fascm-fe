  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!consigneeInfo?.id) {
      toast({
        variant: 'destructive',
        title: 'Error',
        description: 'Consignee information not found.'
      });
      return;
    }
          ...
          <div className='grid gap-6'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your organization details and business information
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Business Certificate</CardTitle>
                <CardDescription>
                  Upload or manage your business certificate
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
