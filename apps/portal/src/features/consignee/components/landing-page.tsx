        ...
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          <div className='grid items-center gap-12 lg:grid-cols-2'>
            <div className='space-y-8'>
              <div className='space-y-4'>
                ...
                <h1 className='text-4xl font-bold leading-tight text-gray-900 lg:text-6xl'>
                  ...
                  <span className='text-green-600'> Nông Sản Minh Bạch</span>
                </h1>
            ...
            <div className='relative'>
              <div className='rounded-2xl bg-gradient-to-br from-green-400 to-green-600 p-8 shadow-2xl'>
          ...
          <div className='grid gap-8 md:grid-cols-2 lg:grid-cols-4'>
            ...
            <Card className='border-green-200 transition-shadow duration-300 hover:shadow-lg'>
              <CardHeader className='text-center'>
                ...
                <CardTitle className='text-blue-800'>📡 IoT Realtime</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className='text-center'>
              ...
              <CardContent className='space-y-4'>
                <div className='grid grid-cols-2 gap-4'>
                  <div className='rounded-lg bg-blue-50 p-4'>
                    ...
                    <p className='mt-2 text-sm text-gray-600'>Nhiệt độ kho</p>
                  </div>
                  <div className='rounded-lg bg-green-50 p-4'>
                    ...
                    <p className='mt-2 text-sm text-gray-600'>Độ ẩm</p>
                  </div>
                </div>
            ...
            <Card className='border-purple-200'>
              ...
              <CardContent className='space-y-4'>
                <div className='rounded-lg bg-purple-50 p-4'>
                  ...
                  <code className='break-all font-mono text-sm text-purple-800'>
                    {blockchainHash}
                  </code>
                </div>
          ...
          <div className='grid gap-8 md:grid-cols-3'>
            ...
            <Card className='border-green-200 text-center'>
              ...
              <CardContent>
                ...
                <p className='text-gray-600'>Phản hồi trong 2 giờ</p>
            ...
            <Card className='border-green-200 text-center'>
              <CardHeader>
                ...
                <CardTitle>Địa chỉ kho</CardTitle>
              </CardHeader>
              <CardContent>
                <p className='mb-2 font-medium text-gray-800'>
                  Khu Công nghệ cao Hòa Lạc
                </p>
                <p className='mb-4 text-gray-600'>Thạch Thất, Hà Nội</p>
                <Button variant='outline' className='mt-4'>
