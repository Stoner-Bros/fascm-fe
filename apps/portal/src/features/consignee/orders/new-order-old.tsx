...
//       const orderDetails: CreateOrderDetailDto[] = lines.map((line) => ({
...
//       // Create order schedule with nested order and order details
//       const schedulePayload: CreateOrderScheduleDto = {
//         description: scheduleDescription || null,
//         deliveryDate: new Date(scheduleDateTime).toISOString(),
//         address: deliveryAddress || null,
//         order: orderData,
//         orderDetails: orderDetails
//       };

//       await createOrderSchedule(schedulePayload);
